...
#ifdef RICHEL
	#define FWVersion		"ver.09/15.2.01.43R_MON"
#endif
#ifdef KUBO
	#define FWVersion		"ver.09/15.2.01.43K_MON"
#endif

											// 1.43 - коррекция по влажности для фрамуг работает если нет дождя. В расчете контуров берем дат RH из источников. Скорость AHU оганичевается Максимумом из параметров.
