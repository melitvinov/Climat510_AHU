...
#ifdef RICHEL
	#define FWVersion		"ver.09/15.2.01.47R_MON"
#endif
#ifdef KUBO
	#define FWVersion		"ver.09/15.2.01.47K_MON"
#endif

											// 1.47 - ограничение скорости AHU перед отправкой
											// 1.46 - Ускорение расчета рукава Держать
											// 1.45 - Переписали работу ряда коррекций экрана в том числе коррекцию по высокой влажности
											// 1.44 - убран максимум фрамуг
											// 1.43 - коррекция по влажности для фрамуг работает если нет дождя. В расчете контуров берем дат RH из источников. Скорость AHU оганичевается Максимумом из параметров. Исправлена работа экрана при низкой температуре
											// 1.42 - работа фрамуги центральной дорожки теплицы KUBO в задании + защита ее по внешней температуре
											// 1.41 - высокая влажность понижает избыточное давление
											// 1.40 - изменен размер Метео блока с 60 на 63 байта + CRC
											// 1.39 - Клапан AHU - RHз - RHи уменьшает максимум на -- не работала настройка
											// 1.38 - CRC8 вместо простого суммирования в Метео и Ручном управлении
											// 1.37 - Линейное разворачивание экрана по внешней темпратуре
											// 1.36 - При расчете Держать рукава увеличели дельту в 2 раза
											// 1.35 - Коррекция по датчикам положения Цирк клапана и фрамуг, мультикасты
											// 1.34 - Клапан AHU корректируется по датчику положения, исправлена ошибка работы клапана при отрицательной температуре
											// 1.33 - Переписан ПИ регулятор для контуров отопления
											// 1.32 - Добавлена диодная досветка и греющий кабель
											// 1.31 - Добавлен контур плодоношения, сохраняется рассчет контуров ПИ регулятора
											// 1.30 - Для цифровых датчиков температуры добавлен флаг состояния + убрал лишнее от 4 контура
											// 1.29 - Исправлена ошибка в скорости AHU по RH
											// 1.28 - Исправления не корректно работающего 3 контура
											// 1.27 - Максимум контура AHU держать теперь устанавливается в Задании. Коррекция скорости по RH
											// 1.26 - Увлажнение панели будет вкл не при 30% открытия клапана, а при задаваемом в Параметрах упр
											// 1.25 - Боковой контур стал контуром плодоношения для Richel
											// 1.24 - Исправления отображения датчика избыточного давления AHU 2
											// 1.23 - Переключение контуров
											// 1.22 - Работа по датчикам положения Экрана и клапана AHU
											// 1.21 - Исправлены часы
											// 1.20 - Исправления для экрана, линейная коррекция
											// 1.19 - По заданию экран работал без шагов
											// 1.18 - Коррекция скорости AHU по датчику давления
											// 1.17 - Если нет сигналов обратной связи досветки работаем по состоянию
											// 1.16 - работа внутреннего увлажнения изменена. Добавлен вывод в меню
